...
def parameter_estimation():
    ...
    def numpyro_model(kf):
        ...
        σp = numpyro.sample("σp", dist.LogUniform(1e-18, 1e-12),sample_shape=(model.Npsr,))

        
        #Measurement noise parameters
        EFAC = numpyro.sample("EFAC", dist.Uniform(0.5, 2),sample_shape=(model.Npsr,))
        EQUAD = numpyro.sample("EQUAD", dist.LogUniform(1e-7, 1e-6),sample_shape=(model.Npsr,))
    ...
    fname = f"outputs/test_parameter_estimation_results_{timestamp}.nc" 
