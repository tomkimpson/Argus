...
# Convenience script to submit the Argus CLI job to Slurm

echo "=== Submitting Argus CLI Analysis Job ==="
echo
...
echo "Output log: outputs/logfiles/cli_run_output.txt"
echo
...
if [ $? -eq 0 ]; then
    ...
    echo "  squeue -u \$USER"
    echo "  tail -f outputs/logfiles/cli_run_output.txt"
else
