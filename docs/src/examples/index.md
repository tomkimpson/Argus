...
This section contains practical examples and tutorials for using Argus in pulsar timing array analysis.
...
!!! tip "Interactive Notebooks"
    Many examples are also available as Jupyter notebooks in the `notebooks/` directory of the repository.