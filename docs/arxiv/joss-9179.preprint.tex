...
detection with a pulsar timing array},
  pdfauthor={Tom Kimpson, Nicholas O'Neill, Andrew Melatos, Patrick M.
Meyers},
  pdflang={en-US},
  colorlinks=true,
  linkcolor={Maroon},
...
\author[1,2%
  %
  \ensuremath\mathparagraph]{Tom Kimpson}
\author[1,2%
  %
  ]{Nicholas O'Neill%
    }
...
\affil[$\mathparagraph$]{Corresponding author:  tom %
   %
}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\texttt{Argus} is a high-performance Python package for detecting and
