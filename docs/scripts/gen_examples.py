...
EXAMPLE_SCRIPTS = [
    ("examples/legacy/parameter_estimation_with_NUTS.py", "examples/nuts_estimation.md"),
    ("examples/legacy/parameter_estimation_with_nested_sampling.py", "examples/nested_sampling_estimation.md"),
    ("examples/legacy/multi_parameter_estimation_with_NUTS.py", "examples/multi_parameter_nuts.md"),
    ("examples/legacy/multi_parameter_estimation_with_nested_sampling.py", "examples/multi_parameter_nested.md"),
    ("examples/legacy/null_parameter_estimation_with_nested_sampling.py", "examples/null_hypothesis_test.md")
]
...
PLACEHOLDER_EXAMPLES = [
    ("examples/multi_parameter_estimation.md", "Multi-parameter Estimation", "Advanced parameter estimation with multiple GW sources"),
    ("examples/custom_noise_models.md", "Custom Noise Models", "Building and using custom noise models"),
    ("examples/gw_detection.md", "Gravitational Wave Detection", "Detecting and characterizing GW signals"),
    ("examples/nanograv_analysis.md", "NANOGrav Analysis", "Analysis using NANOGrav 15-year data"),
    ("examples/mock_data_challenges.md", "Mock Data Challenges", "IPTA mock data challenge analysis"),
    ("examples/custom_datasets.md", "Custom Datasets", "Working with your own timing data"),
    ...
    ("examples/optimization.md", "Optimization Tips", "Performance optimization techniques")
]
